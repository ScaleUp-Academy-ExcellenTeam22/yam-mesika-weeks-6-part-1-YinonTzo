def get_letters() -> tuple:
    """
    :return: tuple with List of lowercase and list of uppercase letters.
    """
    return (create_list_letters('a', 'z'),
            create_list_letters('A', 'Z'))


def create_list_letters(start: str, end: str) -> list:
    """
    Make a range of int- using ord function between start to end.
